...
export const { getDEliveryAdress,getVendorAdress,getIrnOrignalData,getIrndata,getSelectedValue,getMainData,getNewIRN,getIrnPoView,getIrnview,deleteIrnLine,getIrnchange,getUpirno,getBillData,getOrignalData,getTotalQuantity} = irnSlice.actions
