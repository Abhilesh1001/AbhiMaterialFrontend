                    ...
                    <tbody >
                        ...
                        { data?.map((item, index) => {
                                return <tr key={index}>
                                    ...
                                    <td>
                                        {grnview ?<DumyInput indum={item.material_qty}/>:<input type="number" value={item.material_qty != null ? item.material_qty : ''} onChange={(e) => handleChange(e.target.value, 'material_qty', index)} className="form-control  text-sm  w-28" />}
                                    </td>
